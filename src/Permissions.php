...
class Permissions implements ActionHookSubscriber {
    ...
    public function disable_higher_users_select( $roles )
    {
    ...
    public function disable_higher_users_edit( $caps, $cap, $user_id, $args )
    {
        switch( $cap ){
            case 'edit_user':
            case 'remove_user':
